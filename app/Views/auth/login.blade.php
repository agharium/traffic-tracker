        ...
        <div class="card-body">
            ...
            <form hx-post="/login" hx-target="#app" hx-swap="innerHTML">
                ...
                <div class="form-control w-full mb-6">
                    ...
                    <div class="relative">
                        <input type="password" id="password" name="password" placeholder="Enter your password" class="input input-bordered w-full pr-12" required>
                        <button type="button" class="absolute inset-y-0 right-0 flex items-center px-3 text-gray-600 hover:text-gray-800" onclick="togglePassword('password')">
